...
public class ClientServiceIT {
	...
	/*
	  Implementar um teste que ao receber um id existente deve excluir o cliente com o código do id e verificar se realmente decrementou o número de clientes
	  incluídos na base de dados.
	 */
	@Test
	public void deleteShouldExcludeClientWhenIdExists() {
